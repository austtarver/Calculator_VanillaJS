...
function evaluate(equation, operator) {
    ...
    operandOne = arr[0];
    console.log(operandOne.search(/[.]/g));
    operandTwo = arr[1];
    console.log(arr);
    ...
    if (operator === '+') {
        return add(parseFloat(arr[0]), parseFloat(arr[1]));
    } else if (operator === '-') {
        return subtract(parseFloat(arr[0]), parseFloat(arr[1]));
    } else if (operator === 'x') {
        return multiply(parseFloat(arr[0]), parseFloat(arr[1]));
    } else if (operator == "/") {
        return divide(parseFloat(arr[0]), parseFloat(arr[1])).toPrecision(4);
    }
